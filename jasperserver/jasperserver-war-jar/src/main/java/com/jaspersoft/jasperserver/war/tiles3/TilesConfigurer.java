 ...
 *   - paket javax.servlet -> jakarta.servlet
 *   - nama paket disesuaikan ke basis kode ini
 * Perilakunya sengaja dibiarkan identik supaya tata letak halaman tidak berubah.
 *
 * Dua kemampuan opsional Spring dibuang di salinan ini karena artefaknya memang
 * tidak pernah ada di WAR JasperServer, dan Spring sendiri hanya mengaktifkannya
 * kalau kelasnya ditemukan saat runtime:
 *   - evaluasi atribut lewat EL (org.apache.tiles:tiles-el)
 *   - mode "complete autoload" (org.apache.tiles:tiles-extras)
 * Konfigurasi di applicationContext-webapp.xml tidak memakai keduanya, sehingga
 * jalur kode yang tersisa persis sama dengan yang selama ini dijalankan.
 *
 * Sumber asli:
