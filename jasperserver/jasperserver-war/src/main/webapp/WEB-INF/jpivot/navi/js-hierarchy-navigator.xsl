...
<!-- BUGFIX (JPivot navigator / XSLT): deklarasi <xsl:param name="viewUri"/> dihapus.
     Berkas ini selalu di-include bersama ../../wcf/xtree.xsl (lihat navigator.xsl dan
     js-navigator.xsl), dan xtree.xsl sudah mendeklarasikan parameter global yang sama.
     Dua deklarasi global bernama sama dengan import precedence yang sama adalah galat
     menurut XSLT 1.0; Xalan mendiamkannya, Saxon-HE (yang dipakai lewat ServiceLoader
     di WEB-INF/lib) menolaknya dengan XTSE0630 sehingga seluruh dialog navigator kubus
     gagal dirender. Nilainya tetap tersedia dari deklarasi di xtree.xsl. -->
